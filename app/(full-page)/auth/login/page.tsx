...
const Login: Page = () => {
    ...
    return (
        <React.Fragment>
            ...
            >
                {' '}
                <div className="login-image w-5 hidden h-screen md:block" style={{ maxWidth: '500px' }}>
                    <img src="/layout/images/pages/loginimg.webp" className="h-full w-full object-cover" alt="Login" />
                </div>
                    ...
                    >
                        <div className="flex flex-column">
                            <div className="flex  align-items-center mb-6 logo-container">
                                <img src={`/layout/images/logo/temco_logo.webp`} className="login-logo" style={{ width: '300px' }} alt="logo" />
                            ...
                            <div className="button-container">
                                ...
                                <span className="flex text-sm text-color-secondary">
                                    ...
                                    <a href="http://localhost:3000/auth/register" className="cursor-pointer ml-1 text-blue-600 hover:underline">
                                        Sign-up here
                                    </a>
                                </span>
                            </div>
